...
Deletes ALL notification items (old and new PK formats) from DynamoDB.
Works with both DynamoDB Local and AWS DynamoDB.
"""
import os
import sys
import boto3
...
def delete_all_notifications():
    """Delete all items whose PK starts with 'notifications' (old or new format)."""
    last_key = None
    deleted = 0
    scanned = 0
